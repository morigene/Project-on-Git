...
$query = $connect->query("SELECT * FROM staff_table JOIN school ON school.school_id=staff_table.school_id WHERE id=".$_SESSION['userSession']);
        ...
        <ul class="nav navbar-nav">
		  ...
		  <a href="#" class="dropdown-toggle" data-toggle="dropdown">
		    ...
		    <span class="label label-success">
                                                ...
                                                if ($answer_result = $mysqli->query("SELECT * FROM chats WHERE status=0 AND account_type=1 AND staffs_id=$user")) {
...
-->
  ...
  <!--              <div class="pull-left">
				...
				<div class="pull-left">
                  <a href="../admin_work/admin_upload_edit_profile/staff_editform.php?id=<?php echo $userRow['id']?>" class="btn btn-default btn-flat">Edit Profile</a>
                </div>
